CSS (англ. Cascading Style Sheets - каскадні таблиці стилів) - це мова, що визначає стиль відображення HTML-документів. css визначає шрифти, колір елементів, відступи та поля, висоту та ширину елементів та іншим.
