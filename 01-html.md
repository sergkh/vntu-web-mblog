...
`<div>` — `</div>`
: використовується для логічного виділення блоку HTML-документа. Елемент угруповання, як і елемент `<span>`. У сучасному cайтобудуванні використовується як зручний контейнер для об'єктів сторінки, яким легко динамічно маніпулювати — переміщати, вмикати / вимикати, створювати шари, регулювати відступи та інше.
...
`<img src="img3.jpg" width="50px" height="50px" alt="Nice image" align="left"/>Текст, що знаходиться справа`.
...
Опис таблиці повинен складатись з списку рядків, кожен з яких повинен містити хоча б одну комірку. Кількість комірок таблиці може відрізнятись для різних рядків, що дозволяє створювати досить складні таблиці. Простий варіант таблиці матиме вигляд:
