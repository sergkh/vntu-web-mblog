...
>Синтаксис *SQL*, так само як і типи полів, зазвичай незначно відрізняються для різних СКБД, тому бажано звірятись з документацією перед написанням запитів. В даному випадку розглядатиметься синтаксис, який може використовуватись в СКБД *Postre SQL* чи *H2DB*.
